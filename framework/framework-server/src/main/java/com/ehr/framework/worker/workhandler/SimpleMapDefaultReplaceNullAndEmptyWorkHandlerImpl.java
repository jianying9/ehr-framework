...
/**
 * 多个参数单值处理类,次要参数如果为null或则空字符串，用default值代替
 *
 * @author zoe
 */
public class SimpleMapDefaultReplaceNullAndEmptyWorkHandlerImpl implements WorkHandler {
    ...
    public SimpleMapDefaultReplaceNullAndEmptyWorkHandlerImpl(
