 ...
 * @author zoe
 */
public class ExcelModelWriterWorkHandlerImpl implements WorkHandler {
    ...
    public void execute() {
        ...
        responseWriter.writeExcelModel(request, response, this.fieldHandlerMap, this.returnParameter, this.exportFileName);
    }
}
