 ...
 * @author zoe
 */
public class JsonPageWriterWorkHandlerImpl implements WorkHandler {
    ...
    public void execute() {
        ...
        responseWriter.writePageJson(request, response, this.fieldHandlerMap, returnNames);
    }
}
